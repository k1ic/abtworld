      ...
      <Layout title="About">
        <Main>
          ...
          <Typography component="p" variant="h6" className="page-description" color="textSecondary" style={{ fontSize: '15px' }}>
            ...
            (3) 内容可以设置权重，原始单字定价*权重倍数 = 当前单字价格；权重越高，需要支付的ABT越多，上热门的速度随着支付的ABT数量成倍增长，同时可设置的挖矿份额越多；通俗理解就是权重越高，内容传播速度越快和人群越广；<br/>
            (4) 发布者付费的25%给平台，25%给生态伙伴，50%给DApp参与者进行点赞/评论/分享挖矿；参与挖矿的ABT，60%给评论，20%给点赞，20%给分享；<br/>
            (5) 浏览者可以对自己喜欢的快讯进行打赏，打赏ABT 100%给快讯发布者。<br/>
            <br/>
            2. 文章<br/>
            (1) 发布者免费，浏览者付费；<br/>
            (2) 在未付费时，可以预览20%的文章内容；<br/>
            (3) 浏览者付费的60%给作者，20%给平台，20%给生态伙伴。<br/>
          </Typography>
          <Typography component="h2" variant="h5" className="page-header" color="primary" style={{ fontSize: '16px' }}>
            联系方式
          </Typography>
