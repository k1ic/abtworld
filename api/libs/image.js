...
function Base64ImageToFile(base64Data, strFileName){
...
function ImageFileRemove(strPath){
...
//Base64ImageToFile(iconBase64, __dirname+'/tba.png');
//ThumbImageGen('./123.png', './123_thumb.jpg', 25, 25);
